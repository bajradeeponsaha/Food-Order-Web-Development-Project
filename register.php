		...
		<div class="col-md-7 mb-5 site-animate">
            <form action="registerprocess.php" method="post">
              ...
              <div class="form-group">
                ...
                <textarea name="address" name="address" id="address" cols="30" rows="10" class="form-control" placeholder="Write your Address"></textarea>
              </div>
              <div class="form-group">
                <input type="submit" name="submit" class="btn btn-primary btn-lg" value="Register Yourself">
              </div>
            </form>
          </div>
	</div>
